...
Run: `rtk proxy pnpm.cmd --filter @jacobinwwey/notemd-deepseek-harness test -- patch.contract.test.ts`
...
Run: `rtk proxy pnpm.cmd --filter @jacobinwwey/notemd-deepseek-harness test`
