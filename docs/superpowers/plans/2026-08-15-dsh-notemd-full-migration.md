...
- Preserve a clean worktree before each commit. The canonical remote is `git@github.com:Jacobinwwey/dsh-NotEMD.git`; the public npm identity is `dsh-notemd` (npm package names are lowercase).
