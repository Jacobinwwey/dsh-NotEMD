...
- 规范展示/仓库名称统一为 `dsh-NotEMD`；npm identity 与安装标识统一为无 scope 的 public package `dsh-notemd`。旧 scoped package 标识已从 runtime import、Cordis patch row、profile manifest、验收脚本与文档中移除。
